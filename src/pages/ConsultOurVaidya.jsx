...
const BASE_IMG_URL = "https://forntend-bucket.s3.ap-south-1.amazonaws.com/sose/images/ConsultOurvaidya/";

const SecondCarousel = Array.from({ length: 8 }, (_, index) => ({
  id: 11 + index,
  alt_text: `Image${index + 1}`,
  image: `${BASE_IMG_URL}c${index + 1}.jpg`,
  display_status: true,
  image_url: null,
}));
...
export default function ConsultOurVaidya() {
  ...
  const isUserLoggedIn = loginInfo.isLoggedIn;
    ...
    <>
      ...
      <Container maxW="container.xl" px={0}>
        ...
        >
          <Box
            ...
            bottom={0}
            zIndex={1}
            bgImage="https://forntend-bucket.s3.ap-south-1.amazonaws.com/sose/images/vaidh-cover.webp"
            bgSize="cover"
            bgPosition="center"
          />
          <Box
      ...
      <Container maxW="6xl" py={15}>
        <Flex flexDirection={{ base: "column", lg: "row" }}>
          <Flex direction="column" justify="center">
            ...
            <Image
              src={`${BASE_IMG_URL}Consultation_banner.jpg`}
              alt="Free consultation banner"
              my={6}
            />
            <Box bg="brand.300" p="2" borderRadius="5" w={{ base: "90vw", md: "auto" }}>
              <HStack>
                <HiInformationCircle />
                <Text>
                  We also conduct physical consultation at our stores. (Schedule...)
                </Text>
              </HStack>
            </Box>
          </Flex>
          <Flex align="center">
            <Image src={`${BASE_IMG_URL}Illustration1.jpg`} />
          </Flex>
        </Flex>
        ...
        <Box mt={10}>
          ...
          <Container maxW="container.xl" centerContent>
            {loading ? <Skeleton h={489} /> : <CarouselItem banners={SecondCarousel} />}
          </Container>
        </Box>
        ...
        {[1, 2, 3, 4].map((step) => {
          ...
          const Illustration = (
            <Box py={3} flex="1">
              <Image src={`${BASE_IMG_URL}Illustration${step + 1}.jpg`} />
            </Box>
          );
          const StepImage = (
            <Box py={3} flex="1">
              <Image src={`${BASE_IMG_URL}Step${step}_info.jpg`} />
            </Box>
          );
        ...
        >
          ...
          <GridItem>
            ...
            <Text fontSize="19px" color="text.300">
              Experience the power of ancient wisdom with Gaumutra Based Aushadhi – a cherished treasure from our heritage. This natural remedy, distilled from cow urine, offers effective relief from conditions like obesity, urinary disorders, anemia, and even aids in fighting several diseases.
              <br />
              Our vaidyas are ever present with free consultation to guide you about the right kind of aushadhi that will be beneficial for your health.
              <br />
              Visit us today or order online for this authentic healing solution.
            </Text>
            <Button
              onClick={navigateToBooking}
              borderRadius="25px"
      ...
      <Container maxW="6xl" py={15}>
        <Flex m="10" justify="center">
          <Image src={`${BASE_IMG_URL}Statistics.png`} />
        </Flex>
      </Container>
      ...
      <Container maxW="6xl" py={15}>
        <Flex my="10" justify="center" align={"center"} >
          {[0, 1, 2, 3].map((i) => (
            <Box>
              <Image key={i} src={`${BASE_IMG_URL}Footer_illustration${i ? i : ""}.jpg`} />
            </Box>
          ))}
        </Flex>
      </Container>
